...
import { Shield, LayoutDashboard, Link2, Users, UserCheck, Banknote, FileText, BarChart2, ClipboardList, LogOut, Menu, X, ExternalLink, Trash2 } from "lucide-react";
...
const navItems = [
  ...
  { path: "/admin/cleanup", icon: Trash2, label: "Очистка данных" },
];
